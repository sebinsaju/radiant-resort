                ...
                <div className="container py-sm-4">
                    <div className="row">
                        <div className="col-lg-3 col-md-4 col-6">
                            <img src={data.image1} alt="" className="img-fluid" />
                        </div>
                        <div className="col-lg-3 col-md-4 col-6">
                            <img src={data.image2} alt="" className="img-fluid" />
                        </div>
                ...
                <div className="container py-sm-4">
                    <div className="row">
                        ...
                        <div className="col-lg-5 mt-lg-0 mt-4">
                            <img src={data.image3} alt="" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </section></div>
