...
const ChatBoat = () => {
    ...
    return (
        <div style={{position:"fixed",right:"30px",top:"80%",zIndex:"999"}} className=" text-right">
            <div onClick={clickHandler} style={{cursor:"pointer"}}><img src='/whatsapp.png' alt='whatsapp-icon' /></div>
